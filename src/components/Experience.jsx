...
const experiences = [
  ...
  },
  {
    ...
    images: ["/images/projects/qr-traceability.png"],
  },
  {
    year: "2019 — 2026",
    company: "Urban Data",
    ...
    images: ["/images/projects/gps-tools.png"],
  },
]
          ...
          <div className="space-y-24">
            {experiences.map((experience, index) => (
              ...
              >
                ...
                <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_minmax(320px,0.72fr)] xl:items-center">
                  ...
                  {experience.images?.length > 0 && (
                    <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.035] p-2 shadow-[0_30px_90px_rgba(0,0,0,0.3)] backdrop-blur-lg">
                      <ProjectImageSlider
